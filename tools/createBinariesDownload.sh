...
filelist+=("$(find $rootdir/libretrocores/stella-libretro/ -name "*libretro*.so")")
filelist+=("$(find $rootdir/libretrocores/nxengine-libretro/ -name "*libretro*.so")")
filelist+=("$rootdir/libretrocores/nxengine-libretro/datafiles/")
filelist+=("$(find $rootdir/libretrocores/gambatte-libretro/ -name "*libretro*.so")")
filelist+=("$(find $rootdir/libretrocores/libretro-prboom/ -name "*libretro*.so")")
filelist+=("$rootdir/libretrocores/libretro-prboom/prboom.wad")
filelist+=("$(find $rootdir/libretrocores/pocketsnes-libretro/ -name "*libretro*.so")")
filelist+=("$(find $rootdir/libretrocores/pcsx_rearmed/ -name "*libretro*.so")")
filelist+=("$(find $rootdir/libretrocores/mednafen-pce-libretro/ -name "*libretro*.so")")
filelist+=("$(find $rootdir/libretrocores/imame4all-libretro/ -name "*libretro*.so")")
filelist+=("$(find $rootdir/libretrocores/fceu-next/fceumm-code/ -name "*libretro*.so")")
filelist+=("$(find $rootdir/libretrocores/fba-libretro/ -name "*libretro*.so")")
filelist+=("$(find $rootdir/libretrocores/picodrive/ -name "*libretro*.so")")
filelist+=("$(find $rootdir/libretrocores/mednafenpcefast/ -name "*libretro*.so")")
...
filelist+=("$rootdir/emulators/dgen-sdl/installdir/")
