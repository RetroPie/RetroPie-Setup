...
filelist+=("./RetroPie/emulatorcores/Genesis-Plus-GX/libretro.so")
...
filelist+=("./RetroPie/emulators/dgen-sdl-1.30/dgen")
filelist+=("./RetroPie/emulators/dgen-sdl-1.30/sample.dgenrc")
filelist+=("./RetroPie/emulators/dgen-sdl-1.30/installdir/usr/local/bin/dgen_tobin")
filelist+=("./RetroPie/emulators/dgen-sdl-1.30/installdir/usr/local/bin/dgen")
filelist+=("./RetroPie/emulators/dgen-sdl-1.30/installdir/usr/local/share/man/man1/dgen_tobin.1")
filelist+=("./RetroPie/emulators/dgen-sdl-1.30/installdir/usr/local/share/man/man1/dgen.1")
filelist+=("./RetroPie/emulators/dgen-sdl-1.30/installdir/usr/local/share/man/man5/dgenrc.5")
