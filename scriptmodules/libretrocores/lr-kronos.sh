...
rp_module_licence="GPL2 https://raw.githubusercontent.com/libretro-mirrors/Kronos/master/yabause/COPYING"
rp_module_section="exp"
rp_module_flags="!arm !aarch64"

function sources_lr-kronos() {
    gitPullOrClone "$md_build" https://github.com/libretro-mirrors/Kronos.git
}
