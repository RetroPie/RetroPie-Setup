...
function configure_lr-4do() {
    ...
    setESSystem "3DO" "3do" "~/RetroPie/roms/3do" ".iso .ISO" "$rootdir/supplementary/runcommand/runcommand.sh 0 \"$emudir/retroarch/bin/retroarch -L $md_inst/4do_libretro.so --config $configdir/4do/retroarch.cfg %ROM%\" \"$md_id\"" "3do" "3do"
}
