...
rp_module_desc="Capcom CPS2 Arcade emu - Final Burn Alpha (0.2.97.30) port for libretro"
rp_module_help="ROM Extension: .zip\n\nCopy your FBA roms to\n$romdir/fba or\n$romdir/cps2 or\n$romdir/arcade"
rp_module_licence="NONCOM https://raw.githubusercontent.com/libretro/fbalpha2012_cps2/master/src/license.txt"
rp_module_section="opt"

function sources_lr-fbalpha2012-cps2() {
    gitPullOrClone "$md_build" https://github.com/libretro/fbalpha2012_cps2.git
}
...
function configure_lr-fbalpha2012-cps2() {
    local system
    for system in arcade fba cps2; do
        mkRomDir "$system"
