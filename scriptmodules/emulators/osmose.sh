...
function configure_osmose() {
    ...
    setESSystem "Sega Master System / Mark III" "mastersystem-osmose" "~/RetroPie/roms/mastersystem-osmose" ".sms .SMS" "$md_inst/osmose %ROM% -tv -fs" "mastersystem" "mastersystem"
}