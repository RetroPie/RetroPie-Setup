...
rp_module_help="Copy your SAM Coupe roms to $romdir/samcoupe."
...
function configure_simcoupe() {
    ...
    addSystem 1 "$md_id" "samcoupe" "pushd $md_inst; $md_inst/simcoupe autoboot -disk1 %ROM% -fullscreen; popd" "SAM Coupe" ".dsk .mgt .sbt .sad"
}
