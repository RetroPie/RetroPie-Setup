...
function configure_sdltrs() {
    ...
    addEmulator 0 "$md_id-model1-dosload" "trs-80" "$md_inst/sdltrs -scanlines -model 1 -romfile $biosdir/trs-80/level2.rom -diskdir $romdir/trs-80 -disk0 $biosdir/trs-80/newdos.dsk -disk1 %ROM%"
    addEmulator 0 "$md_id-model3-dosload" "trs-80" "$md_inst/sdltrs -scanlines -model 3 -romfile3 $biosdir/trs-80/model3.rom -diskdir $romdir/trs-80 -disk0 $biosdir/trs-80/lddos.dsk -disk1 %ROM%"
    addEmulator 0 "$md_id-model4-dosload" "trs-80" "$md_inst/sdltrs -scanlines -model 4 -romfile3 $biosdir/trs-80/model4.rom -diskdir $romdir/trs-80 -disk0 $biosdir/trs-80/lddos.dsk -disk1 %ROM%"
    addEmulator 0 "$md_id-model4p-dosload" "trs-80" "$md_inst/sdltrs -scanlines -model 4p -romfile4p $biosdir/trs-80/model4p.rom -diskdir $romdir/trs-80 -disk0 $biosdir/trs-80/lddos.dsk -disk1 %ROM%"
    addSystem "trs-80"
